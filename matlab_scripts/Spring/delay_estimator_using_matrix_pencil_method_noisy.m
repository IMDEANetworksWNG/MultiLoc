function [all_gains, all_delays, num_estimated_paths,matrix_estimated_gains,matrix_estimated_delay] = delay_estimator_using_matrix_pencil_method_noisy(multipath_channel,P,z_left,z_right,unit_circle_toll)
...
%         z_l = eig(H_H);
        ...
        index_signal = abs(S) > S_min;
        
        % take the eigen values and the ritgh eigen vector
%         S_signal = S(index_signal);
