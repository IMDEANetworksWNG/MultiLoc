...
mkdir("plots")
mkdir("plots/final_plots/Location_new")
mkdir("plots/final_plots/Location_new/to_overleaf")
...
for ii = 1:length(rotations)
    load(strcat("mat_files/CDF_data_new/",scenario,"/all_",rotations(ii),".mat"))
...
matlab2tikz(char(strcat("plots/final_plots/Location_new/Location_system_",scenario,".tikz")));
savefig(fig,strcat("plots/final_plots/Location_new/Location_system_",scenario));
end

[status,result] = system('bash plots/final_plots/Location_new/modify_plots_all.sh');
