...
% load the angle
load("mat_files/in_out/HF/CSI/csi_in_out_aoa_music.mat")
...
save("mat_files/Coordinates/data_coordinates_hf_bs_in_out","estimated_point_x_hf_bs", "estimated_point_y_hf_bs");
