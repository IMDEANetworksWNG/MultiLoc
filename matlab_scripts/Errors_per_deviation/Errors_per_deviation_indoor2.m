...
for rotation_index=rotations_index
    ...
    if count == 3 || count == 5 || count == 7
        set(h, 'LineStyle', '--', 'color', final_rgb(count, :), 'LineWidth', 2);
    else
        set(h, 'LineStyle', '-', 'color', final_rgb(count, :), 'LineWidth', 2);
    end
    count = count + 1;
...
h = cdfplot(error(:));
set(h, 'LineStyle', '-', 'color', final_rgb(9, :), 'LineWidth', 2);
...
print("plots/final_plots/rotation_comparison/AoA_LOS_Indoor", "-dsvg");
...
print("plots/final_plots/rotation_comparison/AoA_NLOS_Indoor", "-dsvg");
...
print("plots/final_plots/rotation_comparison/ToF_LOS_Indoor", "-dsvg");
...
print("plots/final_plots/rotation_comparison/ToF_NLOS_Indoor", "-dsvg");
