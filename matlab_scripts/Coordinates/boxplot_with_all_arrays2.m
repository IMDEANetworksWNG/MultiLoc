...
MagInset(fig, -1, [0.7 3 0 1], [1 4 15 30], {'NW','NW';'SE','SE'});
...
% [hlegend, hobj, ~, ~] = legend([all_items(1);all_items(2);all_items(3);all_items(4)], {'MultiLoc','HF-Multiloc','HF-Baseline', "Multiband Baseline"}, "Location", "Northwest", 'FontSize', 13);
% % hlegend.FontSize = 13;
