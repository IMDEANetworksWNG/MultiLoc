%% Extractors %%
% extract CSI data
run("Extractors/CSI_extractor_raw.m")

% extract FTM data
run("Extractors/FTM_extractor.m")

%% Calibrate data %%
% CSI
run("Extractors/Calibrate_CSI_Data.m")
% FTM
run("Extractors/Calibrate_FTM_Data.m")
...
%% Run FTM 
run("Process_FTM/Generate_Distances_indoor.m")
