...
for point_id=1:size(measurement_points, 2)
    ...
    path = ['raw_data/aoa_and_ftm/' num2str(measurement_point) '/'];
...
save([out_path 'CSI/csi_indoor2.mat'], 'calculated_aoa', 'csi_raw', 'magnitudes_raw', 'azimut_raw', 'elevation_raw', 'power_raw');
save([out_path 'FTM/ftm_indoor2.mat'], 'calculated_distance', 'tof_raw');
