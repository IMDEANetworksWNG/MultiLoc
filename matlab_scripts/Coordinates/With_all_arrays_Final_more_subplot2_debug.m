...
% load the HF data
load(strcat("mat_files/Coordinates/data_coordinates_hf_",scenarios(scenario),"_amb.mat"))
% load the LF data
...
% savefig(fig,strcat("plots/final_plots_subplot/",scenarios_save(scenario)))
% save_PDF_fig(fig,strcat("plots/final_plots_subplot/",scenarios_save(scenario)))
% 
