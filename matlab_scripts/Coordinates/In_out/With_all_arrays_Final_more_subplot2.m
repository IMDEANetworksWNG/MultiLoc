...
% load the HF data
load("mat_files/Coordinates/data_coordinates_hf_in_out.mat")
% load the LF data
load("mat_files/Coordinates/data_coordinates_lf_in_out.mat")

% load the multiband bbaseline
load("mat_files/Coordinates/data_coordinates_multiband_baseline_in_out.mat")

% load the hf bbaseline
load("mat_files/Coordinates/data_coordinates_hf_bs_in_out.mat")
...
% 
% % Add the optimal
% load('mat_files/in_out/HF/optimal_rotation_index.mat');
% 
% % Only LOS
% load('mat_files/in_out_map/Grid_LOS.mat')
% 
...
%             estimated_point_optimal_x_hf(point_id, ap_id) = estimated_point_x_hf(point_id, ap_id, in_out_optimal_rotation_index(point_id, ap_id));
%             estimated_point_optimal_y_hf(point_id, ap_id) = estimated_point_y_hf(point_id, ap_id, in_out_optimal_rotation_index(point_id, ap_id));
%         end
%     end
% end
% 
...
save(['matlab_scripts//Coordinates/In_out/all_in_out_' num2str(subarrays(ii)) '.mat'], "error_lf_distance", "error_hf_hf_lf_new", "error_hf_tof");

%% Are we choosing the same in LF and HF?
% chosen_ap_with_lf
% chosen_ap_with_hf
load('mat_files/in_out_map/data_distance_angle_true.mat', 'AP_labels_HF')
