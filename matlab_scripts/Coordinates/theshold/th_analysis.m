...
% for scenario = 2
mkdir(strcat("mat_files/th/", scenarios_save(scenario)))
...
%     end
    ...
    error_multiloc_all{th == ths, ii} = error_multiloc(:);
...
save(strcat("mat_files/th/", scenarios_save(scenario), "/error_multiloc_all"), "error_multiloc_all", "ths")
end
