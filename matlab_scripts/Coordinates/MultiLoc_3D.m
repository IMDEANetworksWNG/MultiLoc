...
for scenario = 1:5
% for scenario = 2
mkdir(strcat("mat_files/MultiLoc_3D/", scenarios_save(scenario)))
...
if (scenario == 1 || scenario == 3 )
    load(strcat("mat_files/",scenarios(scenario),"/HF/calculated_aoa_amb_el.mat"))
...
%% Saving the data
save(strcat("mat_files/MultiLoc_3D/",scenarios_save(scenario),"/all_",num2str(subarrays(ii)),".mat"), "error_multiloc_lf", "error_multiloc_hf", "error_multiloc");
savefig(fig,strcat("plots/MultiLoc_3D/",scenarios_save(scenario)))
end
end
