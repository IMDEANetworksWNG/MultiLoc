...
mkdir("plots")
mkdir("plots/final_plots/Location_elevation")
mkdir("plots/final_plots/Location_elevation/to_overleaf")
...
% matlab2tikz(char(strcat("plots/final_plots/Location_elevation/Location_system_",scenario,".tikz")));
savefig(strcat("plots/final_plots/Location_elevation/Location_system_",scenario));
end

% [status,result] = system('bash plots/final_plots/Location/modify_plots_all.sh');
