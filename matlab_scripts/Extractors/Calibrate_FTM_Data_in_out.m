...
mean_offset_final = [mean_offset(1), mean_offset(2)]
...
% 
        load(strcat("../../mat_files/in_out/LF/FTM/", string(id_set), "/FTM_distances_", string(routers_CSI(router))));
%         if (id_set > 74)
...
%         end
        ...
        save(strcat("../../mat_files/in_out/LF/FTM/", string(id_set), "/FTM_distances_calibrated_", string(routers_CSI(router))), "FTM_distances");
