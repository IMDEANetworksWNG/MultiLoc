...
for id_point = 1:n_points
    for id_router = 1:routers
        for id_rotation = 1:(rotations/subarrays(ii))
            ...
            % take the lf one
            estimated_point_x_lf_aux = estimated_point_x_lf_distance_2(id_point);
            estimated_point_y_lf_aux = estimated_point_y_lf_distance_2(id_point);
