...
save([out_path 'CSI/csi_indoor.mat'], 'calculated_aoa', 'csi_raw', 'magnitudes_raw', 'azimut_raw', 'elevation_raw', 'power_raw');
save([out_path 'FTM/ftm_indoor.mat'], 'calculated_distance', 'tof_raw');
