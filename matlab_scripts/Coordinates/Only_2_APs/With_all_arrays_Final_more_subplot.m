...
error_mb_lbs = sqrt((points_x - estimated_point_x_mb_bs_2).^2 + (points_y - estimated_point_y_mb_bs_2).^2);

index_nan_error_mb_lbs = isnan(error_mb_lbs);
error_mb_lbs(index_nan_error_tof) = Inf;
