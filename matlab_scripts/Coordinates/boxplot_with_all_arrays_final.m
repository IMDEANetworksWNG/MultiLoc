...
mkdir("plots")
mkdir("plots/final_plots")
mkdir("plots/final_plots/Location")
mkdir("plots/final_plots/Location/to_overleaf")
...
% end
% [hlegend, hobj, ~, ~] = columnlegend(10, ['MultiLoc', "MB Baseline",'HF MultiLoc','HF Baseline'], "Location", "northwest");%, 'FontSize', 12);
% [hlegend, hobj, ~, ~] = legend([all_items(1);all_items(2);all_items(3);all_items(4)], {'MultiLoc', "MB Baseline",'HF MultiLoc','HF Baseline'}, "Location", "northwest",'NumColumns',2, 'FontSize', 12);
hlegend = legend(['MultiLoc', "MB Baseline",'HF MultiLoc','HF Baseline'], "Location", "northoutside",'NumColumns',4);
% hlegend.FontSize = 13;
...
MagInset(fig, -1, [0.9 4.15 0 1], [1.2 4 20 30], {'NW','NW';'SE','SE'});
set(gca, "fontsize", 12)
set(gca, 'YGrid', 'on', 'XGrid', 'off')

% xlabels = strcat(string([8,4,2,1]), " array");
% xlabels(1:end-1) = xlabels(1:end-1) + "s";
set(gca,'xtick',positions(2:4:12) + 0.1)
set(gca,'xticklabel',xlabels(1:3))
...
save_PDF_fig(fig, "plots/final_plots/Location/to_overleaf/Boxplot")
savefig(fig, "plots/final_plots/Location/to_overleaf/Boxplot")
print(fig, "plots/final_plots/Location/to_overleaf/Boxplot", "-dsvg")
% hLegend.LineWidth = 2;
