...
% Calibrate
angles_dp_lf(:,2) = angles_dp_lf(:,2) + 3.5;
angles_dp_lf(:,3) = angles_dp_lf(:,3) - 2;
...
cal = [-1.2149    2.4969   11.2493    0.1515];
...
angles_dp = angles_dp;
% save("angles_dp"
save("mat_files/outdoor/HF/CSI/angles_dp_amb.mat","angles_dp")
angles_dp(:,1,:) = angles_dp(:,1,:) - cal(1);
angles_dp(:,2,:) = angles_dp(:,2,:) - cal(2);
angles_dp(:,3,:) = angles_dp(:,3,:) - cal(3);
angles_dp(:,4,:) = angles_dp(:,4,:) - cal(4);
...
estimated_point_x_hf = estimated_point_x;
estimated_point_y_hf = estimated_point_y;

save("mat_files/Coordinates/data_coordinates_hf_outdoor_amb","estimated_point_x_hf", "estimated_point_y_hf");
