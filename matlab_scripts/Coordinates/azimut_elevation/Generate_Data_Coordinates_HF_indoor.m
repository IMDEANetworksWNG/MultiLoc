...
load("mat_files/indoor/HF/CSI/calculated_el_indoor.mat")
...
angles_dp = asind(sind(angles_dp).*cosd(calculated_el));
...
save("mat_files/Coordinates/data_coordinates_hf_indoor_el","estimated_point_x_hf", "estimated_point_y_hf");
