...
for id_rotation = 1:rotations
    for id_router = 1:routers
        for id_point = 1:n_points
            ...
            estimated_point_x_aux = sind(angles_dp(id_point,id_router, id_rotation))*cosd(calculated_el(id_point,id_router, id_rotation))*estimated_distance(id_point,id_router, id_rotation);
            estimated_point_y_aux = cosd(angles_dp(id_point,id_router, id_rotation))*cosd(calculated_el(id_point,id_router, id_rotation))*estimated_distance(id_point,id_router, id_rotation);
...
save("mat_files/Coordinates/data_coordinates_hf_indoor_elevation","estimated_point_x_hf", "estimated_point_y_hf", "estimated_point_z_hf");
