...
%     alpha = 1;
    ...
    error_multiloc_all{ii,find(alpha == alphas)} = error_multiloc;
...
save(strcat("mat_files/CDF_data_new/",scenarios_save(scenario),"_error_multiloc_all"), "error_multiloc_all");
end
