...
mkdir("plots")
mkdir("plots/final_plots_subplot_new_larger")
...
mkdir("mat_files/")
mkdir("mat_files/CDF_data_new_larger")
...
for scenario = 1:5
% for scenario = 2
mkdir(strcat("mat_files/CDF_data_new_larger/", scenarios_save(scenario)))
...
%% Saving the data
save(strcat("mat_files/CDF_data_new_larger/",scenarios_save(scenario),"/all_",num2str(subarrays(ii)),".mat"), "error_multiloc_lf", "error_multiloc_hf", "error_multiloc", "error_mb_bs_mean", "error_mb_bs_ap", "error_hf_bs_mean", "error_hf_bs_ap");
savefig(fig,strcat("plots/final_plots_subplot_new_larger/",scenarios_save(scenario)))
save_PDF_fig(fig,strcat("plots/final_plots_subplot_new_larger/",scenarios_save(scenario)))
