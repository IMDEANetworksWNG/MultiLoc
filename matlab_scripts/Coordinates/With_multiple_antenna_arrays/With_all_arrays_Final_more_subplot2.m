...
% load the HF data
load("mat_files/Coordinates/data_coordinates_hf_indoor.mat")
% load the LF data
load("mat_files/Coordinates/data_coordinates_lf_indoor.mat")

% load the multiband bbaseline
load("mat_files/Coordinates/data_coordinates_multiband_baseline_indoor.mat")

% load the hf bbaseline
load("mat_files/Coordinates/data_coordinates_hf_bs_indoor.mat")
